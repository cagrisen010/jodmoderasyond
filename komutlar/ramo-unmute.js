...
const mutelog = message.guild.channels.cache.find(c => c.id === '835590322977374228')//Mute log
const muterol = message.guild.roles.cache.find(r => r.id === '834128632871780419')//Muteli rolü
