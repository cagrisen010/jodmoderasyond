...
const mutelog = message.guild.channels.cache.find(c => c.id === '791291504538812487')//Mute log
const muterol = message.guild.roles.cache.find(r => r.id === '791292346561069057')//Muteli rolü
