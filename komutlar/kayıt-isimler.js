...
module.exports.run = async (client, message, users, args) => {
    ...
    if(!message.member.roles.cache.some(r => ['782632333790150657', '782632294614695956'].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
if(!isim) return message.channel.sen('Bir Kullanıcı Belirt.')
